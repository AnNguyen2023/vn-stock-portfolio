...
export default function WLAddTickerModal({ isOpen, onClose, onAdd }) {
            ...
            <div className="bg-white rounded-[32px] p-8 w-full max-w-sm shadow-2xl animate-in zoom-in-95 duration-200 border border-slate-100">
                ...
                <div className="relative mb-8">
                    <input
                        ...
                        className="w-full p-5 bg-[#f8fafc] border-2 border-[#d1fae5] rounded-[24px] text-slate-700 outline-none focus:border-emerald-400 transition-all font-bold uppercase placeholder:text-slate-400"
                        autoFocus
                ...
                <div className="flex gap-4">
                    ...
                    <button onClick={handleAdd} className="flex-1 py-4 bg-[#00b894] text-white font-medium rounded-2xl text-sm uppercase hover:bg-[#00a383] transition-all shadow-lg shadow-emerald-100">Thêm</button>
                </div>
            </div>
        </div>
    );
